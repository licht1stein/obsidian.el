...
NOTE: Using window configuration packages such as Eyebrowser or Perspective may prevent all of the backlinks panels from closing

**** Window configuration packages
***** Eyebrowse
