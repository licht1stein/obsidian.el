...
I wanted to work with Obsidian Notes using Emacs. Obviously you already can open your Obsidian folder and start creating markdown files with Emacs. Let's try to improve that a little, and split the responsibilities between Emacs and Obsidian the way it makes sense.
...
** Org-roam or and other great Emacs libraries?
